...
--changeset nivethidhas:JIRA-1234_EXTERNAL_DB-INVESTOR-STG_STORE_SALES_07-02-2025_15:02

USE DATABASE EXTERNAL_DB;
USE SCHEMA Investor;

CREATE OR REPLACE TABLE STG_STORE_SALES
(
...
--rollback DROP TABLE STG_STORE_SALES;

--changeset nivethidhas:JIRA-1234_EXTERNAL_DB-INVESTOR-STG_STORE_SALES_07-02-2025_15:03
INSERT INTO STG_STORE_SALES (SELECT * FROM SNOWFLAKE_SAMPLE_DATA.TPCDS_SF100TCL.STORE_SALES LIMIT 100);

--rollback DELETE FROM STG_STORE_SALES;
